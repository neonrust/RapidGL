...
void Bloom::init_app()
{
    ...
    wooden_floor_albedo_map   ->SetWrapping(RGL::TextureWrappingAxis::U, RGL::TextureWrappingParam::Repeat); wooden_floor_albedo_map   ->SetWrapping(RGL::TextureWrappingAxis::V, RGL::TextureWrappingParam::Repeat);
    wooden_floor_normal_map   ->SetWrapping(RGL::TextureWrappingAxis::U, RGL::TextureWrappingParam::Repeat); wooden_floor_normal_map   ->SetWrapping(RGL::TextureWrappingAxis::V, RGL::TextureWrappingParam::Repeat);
    wooden_floor_roughness_map->SetWrapping(RGL::TextureWrappingAxis::U, RGL::TextureWrappingParam::Repeat); wooden_floor_roughness_map->SetWrapping(RGL::TextureWrappingAxis::V, RGL::TextureWrappingParam::Repeat);
    wooden_floor_ao_map       ->SetWrapping(RGL::TextureWrappingAxis::U, RGL::TextureWrappingParam::Repeat); wooden_floor_ao_map       ->SetWrapping(RGL::TextureWrappingAxis::V, RGL::TextureWrappingParam::Repeat);
