...
private:
	...
	void renderSceneShadow(const glm::vec3 &pos, float far_z, uint32_t shadow_params_index, uint32_t shadow_map_index, RGL::RenderTarget::Texture2d &target, const glm::ivec4 &rect={0,0,0,0});
